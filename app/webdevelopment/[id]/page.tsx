...
export function generateStaticParams() {
  return projects.filter(p => p.category === 'web').map((project) => ({ id: project.id }));
}

export default function WebDevelopmentProjectPage({ params }: ProjectPageProps) {
  const project = projects.find((p) => p.id === params.id && p.category === 'web');
